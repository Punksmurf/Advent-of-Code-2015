...
public class SecurityElf
{
	...
	{
		return isStraightMatch(password)
	 ...
	 */
	private boolean isStraightMatch(String input)
	{
	 ...
	 */
	private boolean containsForbiddenLetters(String input)
	{
	 ...
	 */
	private boolean containsTwoDifferentNonOverlappingPairs(String password)
	{
